...
const TopVillas = () => {
  return (
    <section id="topVillas">
      ...
      <p>
      Discover our top pick villas, hand-selected for their unique charm and outstanding features. Experience the epitome of luxury living in these stunning properties that promise an unforgettable stay.
      </p>
